...
@Config
@Autonomous
public class RedOverBarrierCorrected extends LinearOpMode { //mirrored
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Path redob2ndintake = new Path(false);

        toHubStarter.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob0);
        toWarehouse.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob1);
        intake.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob2);
        back.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob3);
        toHub.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob4);
        redob2ndintake.generatePath(hardwareMap, org.firstinspires.ftc.teamcode.R.raw.redob2ndintake);

        toHubStarter.initializePath(40, 40, 5, 4);
        toWarehouse.initializePath(40, 40, 5, 8);
        intake.initializePath(30, 30, 20, 8);
        back.initializePath(40, 40, 20, 8);
        toHub.initializePath(40, 40, 5, 8);
        redob2ndintake.initializePath(40, 40, 5, 8);
        ...
        while (!isStopRequested() && !tracker.isDone()) { //tohub1
            ...
            telemetry.addData("delta time", t.milliseconds() - prevtime);
...
//        while (t.milliseconds() < 500)
//            R.lift.update(low_pos);
        tracker.rotateTo(-90, low_pos - 200);
        ...
        t = new ElapsedTime();
        prevtime = 0;
        while (!tracker.isDone() && !R.intake.isFullAndYellow() && !isStopRequested()) {
            ...
            if (Math.abs(R.imu.getTiltHeading()) > 3)
                ...
                R.drivetrainTank.setPower(drivePower);
            if (R.intake.isFull() && !R.intake.isYellow()) {
                R.drivetrainTank.setPowerSimple(0,0);
                R.intake.autoOutAsync(0.8);
            }
            else
